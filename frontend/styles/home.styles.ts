...
export const createHomeStyles = ({ sw, sh, ms, width, isTablet }: Scalers) => {
  ...
  return {
    ...
    styles: StyleSheet.create({
      ...
      googleSectionLabelSpaced: {
        paddingTop: sh(8),
      },
      /** Notification-style status (blue dot + label, like notifications screen) */
      statusIndicatorRow: {
        flexDirection: 'row',
        alignItems: 'center',
        gap: sw(8),
      ...
      statusIndicatorTextMuted: {
        fontSize: ms(13),
        fontWeight: '500',
        color: '#5f6368',
      },
      statusIndicatorTextWarning: {
        color: '#b06000',
      },
      statusIndicatorTextError: {
        color: '#c5221f',
      },
      statusIndicatorTextSuccess: {
        color: '#188038',
      },
      googleTextBtn: {
        alignItems: 'center',
